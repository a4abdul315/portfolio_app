        ...
        <div className="app__header-badge">
          <div className="badge-cmp app__flex">
            ...
            <div style={{ marginLeft: 2 }}>
              ...
              <h1 className="head-text">Abdul Rehman</h1>
            </div>
          </div>

          <div className="tag-cmp app__flex">
            <p className="p-text">
              <Typewriter words={["React JS", "Next JS", "Graphic Designer", "FullStack Web Developer"]} loop={false} cursor cursorStyle="|" typeSpeed={100} deleteSpeed={80} delaySpeed={2500} />
            </p>
          </div>
        </div>
      </motion.div>
